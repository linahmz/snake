...
class Jeu:
    ...
    def fonction_principale(self):
        ...
        while self.ecran_du_debut:
            ...
            for evenement in pygame.event.get():
                ...
                self.message_entree("moyenne", "Appuyez sur Entrée pour commencer",(180,520,200,5),(230,60,12))
    ...
    def cadre(self): #création des limites du jeu
        ...
        pygame.draw.rect(self.ecran,(0,0,0),(0,80,800,1),3)
    ...
    def affichage(self):
        ...
        self.ecran.fill((252,220,18)) # le remplissage de l'écran est indiqué dans cette boucle car il doit tout le temps être mis à jour pour qu'on puisse voir correctement le mouvement du serpent
            ...
            #afficher la pomme
        pygame.draw.rect(self.ecran, (255,0,0), (self.pomme_x,self.pomme_y,self.pomme,self.pomme))

    def afficher_serpent(self):
            #afficher les parties du serpent qu'il nous faut
        for partie_du_serpent in self.positions_serpent:
            pygame.draw.rect(self.ecran,(27,79,8),(partie_du_serpent[0],partie_du_serpent[1],self.serpent_dimension, self.serpent_dimension))
    ...
    def recommencement_du_jeu(self):
        ...
        while self.perdu == True :
            ...
            self. message_entree('moyenne', " Pour rejouer taper sur Entrée", (200,400,400,40), (150,80,0))
